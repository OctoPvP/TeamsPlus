...
public class PlayerDataParser implements ArgumentParser<CommandSourceStack, PlayerData> {
    private final boolean allowOffline;

    @Override
    public @NonNull ArgumentParseResult<PlayerData> parse(@NonNull CommandContext<@NonNull CommandSourceStack> commandContext, @NonNull CommandInput commandInput) {
        ...
        return ArgumentParseResult.failure(
                new RuntimeException("No player name provided")
        );
    }
}
